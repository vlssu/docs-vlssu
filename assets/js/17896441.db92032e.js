...
var lib = __webpack_require__(2097);
...
var CopyButton_styles_module = __webpack_require__(5770);
...
function useCurrentSidebarCategory(...args) {
  return (__webpack_require__(7276)/* .useCurrentSidebarCategory */ .$S)(...args);
}
function filterDocCardListItems(...args) {
  return (__webpack_require__(7276)/* .filterDocCardListItems */ .d1)(...args);
}
function useDocsPreferredVersion(...args) {
  return (__webpack_require__(7276)/* .useDocsPreferredVersion */ .g1)(...args);
}
function useContextualSearchFilters() {
  const { i18n } = useDocusaurusContext();
  const docsTags = (
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    (__webpack_require__(7276)/* .useDocsContextualSearchTags */ .vF)()
  );
